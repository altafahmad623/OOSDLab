...
class Number            // defining the required class
{
    public:             // defining the public domain which contains all the methods and attributes
        ...
        Number operator * (Number const &obj)       //member operator to multiplt the two numbers
        {
            Number output;                  // output class for the multiplication output
            string num1 = num;              // taking the values of the classes as numbers
            string num2 = obj.num;
            ...
            output.num = answer;
            return output;          // returning the class
        }
};
